...
class PH_AddChiTietXinNghiPhep extends StatefulWidget {
  final String studentId;
  final List item;
  final bool isEdit;
  const PH_AddChiTietXinNghiPhep(
      {Key? key,
  ...
  @override
  State<PH_AddChiTietXinNghiPhep> createState() =>
      _PH_AddChiTietXinNghiPhepState();
}

class _PH_AddChiTietXinNghiPhepState extends State<PH_AddChiTietXinNghiPhep> {
  ...
  Future<void> submitData() async {
    final isSuccess = await XinNghiPhepService.submitDataPh(body);
