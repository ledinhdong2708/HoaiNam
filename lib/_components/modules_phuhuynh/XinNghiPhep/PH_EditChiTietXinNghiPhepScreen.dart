...
class PH_EditChiTietXinNghiPhepScreen extends StatefulWidget {
  final Map? item;
  const PH_EditChiTietXinNghiPhepScreen({Key? key, this.item})
      : super(key: key);

  @override
  State<PH_EditChiTietXinNghiPhepScreen> createState() =>
      _PH_EditChiTietXinNghiPhepScreenState();
}

class _PH_EditChiTietXinNghiPhepScreenState
    extends State<PH_EditChiTietXinNghiPhepScreen> {
  ...
  Future<void> updateData() async {
    int idPhep = widget.item!["id"];
    final isSuccess =
        await XinNghiPhepService.updateDataPh(idPhep, dsNghiPhep!);
