...
import 'PH_AddChiTietXinNghiPhep.dart';

class PH_XinNghiPhepScreen extends StatefulWidget {
  Map? item;
  String img;
  String text;
  PH_XinNghiPhepScreen(this.item, this.img, this.text);
  // const PH_XinNghiPhepScreen({Key? key}) : super(key: key);

  @override
  State<PH_XinNghiPhepScreen> createState() => _PH_XinNghiPhepScreenState();
}

// final Future<SharedPreferences> _prefs = SharedPreferences.getInstance();
class _PH_XinNghiPhepScreenState extends State<PH_XinNghiPhepScreen> {
  ...
  Future<void> getStorage() async {
    ...
    setState(() {
      userId = body['studentID'].toString();
    });
  }
  ...
  Future<void> navigateToAddPage() async {
    ...
    // String? value = await prefs.getString('jwt');
    final body = json.decode(value!);
    if (body['studentID'].toString() != null || isEdit) {
      final route = MaterialPageRoute(
        builder: (context) => PH_AddChiTietXinNghiPhep(
      ...
      ScaffoldMessenger.of(context)
        ...
        ..showSnackBar(SnackBar(content: Text('Không tìm thấy ID học sinh')));
    }
  }
  ...
  Future<void> navigateToEditPage(Map item) async {
    ...
    print(item);
    final route = MaterialPageRoute(
      builder: (context) => PH_EditChiTietXinNghiPhepScreen(item: item),
    );
    final result = await Navigator.push(context, route);
    setState(() {
      var isLoading = true;
