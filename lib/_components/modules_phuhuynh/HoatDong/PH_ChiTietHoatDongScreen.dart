...
class PH_ChiTietHoatDongScreen extends StatefulWidget {
  final Map? item;
  const PH_ChiTietHoatDongScreen({Key? key, this.item}) : super(key: key);

  @override
  State<PH_ChiTietHoatDongScreen> createState() => _PH_ChiTietHoatDongScreen();
}

class _PH_ChiTietHoatDongScreen extends State<PH_ChiTietHoatDongScreen> {
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(
                          'Tên giáo viên: ${widget.item!["name"]}',
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 16,
                          ),
