...
class PH_MembersGroupScreen extends StatefulWidget {
  @override
  final String groupId;
  final List<String> members;
  PH_MembersGroupScreen({
    required this.groupId,
    required this.members,
    Key? key,
  }) : super(key: key);
  _PHMembersGroupScreenState createState() => _PHMembersGroupScreenState();
}

class _PHMembersGroupScreenState extends State<PH_MembersGroupScreen> {
