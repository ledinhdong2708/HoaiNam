...
import 'package:appflutter_one/_components/modules_phuhuynh/Chat/PH_GroupChatPageScreen.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';

class PH_ChatScreen extends StatefulWidget {
  @override
  _PH_ChatScreenState createState() => _PH_ChatScreenState();
}

class _PH_ChatScreenState extends State<PH_ChatScreen> {
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => PH_GroupChatPageScreen(
