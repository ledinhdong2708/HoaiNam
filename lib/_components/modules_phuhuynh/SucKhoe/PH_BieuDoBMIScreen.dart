...
class PH_BieuDoBMIScreen extends StatefulWidget {
  final int StudentId;
  final String title;
  const PH_BieuDoBMIScreen(
      {Key? key, required this.StudentId, required this.title})
      : super(key: key);

  @override
  State<PH_BieuDoBMIScreen> createState() => _PH_BieuDoBMIScreenState();
}

class _PH_BieuDoBMIScreenState extends State<PH_BieuDoBMIScreen> {
