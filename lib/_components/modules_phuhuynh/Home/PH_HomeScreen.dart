...
import 'package:appflutter_one/_components/modules_phuhuynh/Chat/PH_ChatScreen.dart';
import 'package:appflutter_one/_components/modules_phuhuynh/DanThuoc/PH_DanThuocScreen.dart';
import 'package:appflutter_one/_components/modules_phuhuynh/DinhDuong/PH_DinhDuongScreen.dart';
import 'package:appflutter_one/_components/modules_phuhuynh/HoatDong/PH_DSPhanCongSreen.dart';
import 'package:appflutter_one/_components/modules_phuhuynh/HocPhi/PH_HocPhiScreen.dart';
import 'package:appflutter_one/_components/modules_phuhuynh/NhatKy/PH_NhatKyScreen.dart';
import 'package:appflutter_one/_components/modules_phuhuynh/SoBeNgoan/PH_SoBeNgoanScreen.dart';
import 'package:appflutter_one/_components/modules_phuhuynh/SucKhoe/PH_SucKhoeScreen.dart';
import 'package:appflutter_one/_components/modules_phuhuynh/ThoiKhoaBieu/PH_ThoiKhoaBieuScreen.dart';
import 'package:appflutter_one/_components/modules_phuhuynh/TinTuc/PH_TinTucScreen.dart';
import 'package:appflutter_one/_components/modules_phuhuynh/XinNghiPhep/PH_XinNghiPhepScreen.dart';
...
class PH_HomeScreen extends StatefulWidget {
  const PH_HomeScreen({super.key});
  ...
  @override
  State<PH_HomeScreen> createState() => _PH_HomeScreen();
}

class _PH_HomeScreen extends State<PH_HomeScreen> {
                              ...
                              onTap: () {
                                ...
                                if (menus == "TKB") {
                                  ...
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => PH_NhatKyScreen(
                                              categoryMenu_New[index]["id"],
                                              categoryMenu_New[index]
                                                  ["name"])));
                                } else if (menus == "DD") {
                                  ...
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => PH_HocPhiScreen(
                                              categoryMenu_New[index]["id"],
                                  ...
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => PH_TinTucScreen(
                                              categoryMenu_New[index]["id"],
                                              categoryMenu_New[index]
                                                  ["name"])));
                                } else if (menus == "HDGV") {
  ...
  Future<void> FetchHocPhibyId() async {
    final response = await HocPhiService.PH_FetchHocPhiByStudent();
    if (response != null) {
      setState(() {
  ...
  Future<void> FetchXinNghiPhepbyId() async {
    final response = await XinNghiPhepService.PH_FetchHocPhiByStudent();
    if (response != null) {
      setState(() {
        // items!["chiTietHocPhis"] = response["data"]["chiTietHocPhis"];
        items_XinNghiPhep = response["data"];
        print("ahhfjs");
        print(items_XinNghiPhep);
        // return Future.value("Data successfully");
      });
    } else {
      showErrorMessage(context, message: 'Something went wrong');
