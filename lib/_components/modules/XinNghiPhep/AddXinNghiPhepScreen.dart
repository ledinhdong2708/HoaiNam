...
class AddXinNghiPhepScreen extends StatefulWidget {
  final Map? item;
  const AddXinNghiPhepScreen({Key? key, this.item}) : super(key: key);

  @override
  State<AddXinNghiPhepScreen> createState() => _AddXinNghiPhepScreenState();
}

class _AddXinNghiPhepScreenState extends State<AddXinNghiPhepScreen> {
  ...
  Future<void> navigateToEditPage(Map item) async {
    final route = MaterialPageRoute(
      builder: (context) => EditChiTietXinNghiPhepScreen(item: item),
    );
    final result = await Navigator.push(context, route);
    setState(() {
      var isLoading = true;
