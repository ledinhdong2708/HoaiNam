...
class BieuDoBMIScreen extends StatefulWidget {
  final int StudentId;
  final String title;
  const BieuDoBMIScreen(
      {Key? key, required this.StudentId, required this.title})
      : super(key: key);

  @override
  State<BieuDoBMIScreen> createState() => _BieuDoBMIScreenState();
}

class _BieuDoBMIScreenState extends State<BieuDoBMIScreen> {
