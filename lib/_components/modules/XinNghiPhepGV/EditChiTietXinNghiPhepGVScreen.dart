...
class EditChiTietXinNghiPhepGVScreen extends StatefulWidget {
  final Map? item;
  const EditChiTietXinNghiPhepGVScreen({Key? key, this.item}) : super(key: key);

  @override
  State<EditChiTietXinNghiPhepGVScreen> createState() =>
      _EditChiTietXinNghiPhepGVScreenState();
}

class _EditChiTietXinNghiPhepGVScreenState
    extends State<EditChiTietXinNghiPhepGVScreen> {
