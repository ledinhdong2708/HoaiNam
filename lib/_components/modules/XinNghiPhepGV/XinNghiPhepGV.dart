...
import 'package:appflutter_one/_components/modules/XinNghiPhepGV/AddXinNghiPhepGVScreen.dart';
import 'package:appflutter_one/_components/modules/XinNghiPhepGV/XinNghiPhepCardScreen.dart';
import 'package:flutter/material.dart';

import '../../_services/Notification/NotificationService.dart';
import '../../shared/utils/snackbar_helper.dart';

class XinNghiPhepGVPage extends StatefulWidget {
  String img;
  String text;
  XinNghiPhepGVPage(this.img, this.text);
  // const XinNghiPhepGVPage({Key? key}) : super(key: key);

  @override
  State<XinNghiPhepGVPage> createState() => _XinNghiPhepGVPageState();
}

class _XinNghiPhepGVPageState extends State<XinNghiPhepGVPage> {
                    ...
                    children: [
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return XinNghiPhepGVCardScreen(
                              index: index,
                              item: item,
  ...
  Future<void> navigateToEditPage(Map item) async {
    final route = MaterialPageRoute(
      builder: (context) => AddXinNghiPhepGVScreen(item: item),
    );
  ...
  Future<void> FetchXinNghiPhepByDate() async {
    final response = await XinNghiPhepGvService.FetchXinNghiPhepByDate(
        selectedDate.day, selectedDate.month, selectedDate.year);
    if (response != null) {
      print("kết quả: $response");
      setState(() {
        dataView = response["xinPhepGV"];
      });
    } else {
      print("not");
